...
(function (a) {
	window.elFinder = function (b, c) {
		...
		this.tmb = function (b) {
			...
			return d && (a.browser && a.browser.opera || a.browser.msie) && (d += "?_=" + (new Date).getTime()),
			d
		},
		...
		this.shortcut = function (b) {
			...
			if (this.options.allowShortcuts && b.pattern && a.isFunction(b.callback)) {
				...
				for (f = 0; f < c.length; f++)
					d = c[f], g = d.split("+"), e = (e = g.pop()).length == 1 ? e > 0 ? e : e.charCodeAt(0) : a.ui.keyCode[e], e && !u[d] && (u[d] = {
							keyCode : e,
	...
	elFinder.prototype = {
		...
		uploads : {
			iframe : function (b, c) {
				...
				i = a.browser ? a.browser.msie : false,
				j = function () {
					o && clearTimeout(o),
					n && clearTimeout(n),
					m && d.notify({
			...
			xhr : function (b, c) {
				...
				f.send(g);
				if (a.browser && !a.browser.safari || !b.files)
					m = l();
				return e
			}
		},
	...
	elFinder.prototype.commands.download = function () {
		...
		this.getstate = function () {
			...
			c = b.length;
			return !this._disabled && c && (a.browser && !a.browser.msie || c == 1) && c == d(b).length ? 0 : -1
		},
		this.exec = function (b) {
			var c = this.fm,
			e = c.options.url,
			...
			return a(h).appendTo("body").ready(function () {
				...
				}, a.browser && a.browser.mozilla ? 2e4 + 1e4 * j : 1e3)
			}),
			c.trigger("download", {
				files : f
			}),
	...
	elFinder.prototype.commands.quicklook.plugins = [function (b) {
			...
			e = b.preview,
			f = !1;
			a.browser && a.browser.safari && navigator.platform.indexOf("Mac") != -1 || (a.browser && a.browser.msie) ? f = !0 : a.each(navigator.plugins, function (b, c) {
			...
			f = function (b, d) {
				...
				ab = {
					...
					update : function (b, c) {
						...
						!c || (a.browser && (a.browser.opera || a.browser.msie)) && parseInt(a.browser.version) < 9 ? X.rotate(b) : X.animate({
							rotate : b + "deg"
						}),
						b %= 360,
						b < 0 && (b += 360),
	...
	function (a) {
		...
		if (a.browser && a.browser.msie && parseInt(a.browser.version) < 9) {
			var c = function (a) {
				var b = a,
				c = b.offsetLeft,
				d = b.offsetTop;
